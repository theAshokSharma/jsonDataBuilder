// schema-registry.js (Hybrid: localStorage with per-user namespace)

const REGISTRY_PREFIX = 'jb_schema_registry';
...
export function setCurrentUser(username) {
  localStorage.setItem('jb-username', username.trim().toLowerCase());
}
